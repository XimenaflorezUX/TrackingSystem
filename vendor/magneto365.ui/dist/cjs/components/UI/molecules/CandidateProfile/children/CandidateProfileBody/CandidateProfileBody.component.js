...
var CandidateProfileBody_module = require('./CandidateProfileBody.module.scss.js');
...
var cx = classNames_util.classNames.bind(CandidateProfileBody_module);
var Component = function (_a) {
    var children = _a.children, props = tslib_es6.__rest(_a, ["children"]);
    var open = Collapse_component.Collapse.useCollapse().open;
    return (React__default["default"].createElement(Collapse_component.Collapse.Body, tslib_es6.__assign({ className: cx('magneto-ui-candidate-profile-body', {
...
exports.CandidateProfileBody = CandidateProfileBody;
