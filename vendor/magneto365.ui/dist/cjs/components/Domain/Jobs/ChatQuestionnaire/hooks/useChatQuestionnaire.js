...
var useChatQuestionnaire = function (questionsParam) {
    var _a = React.useState(function () { return initilizeQuestions(questionsParam); }), questions = _a[0], setQuestions = _a[1];
    var currentIndex = React.useRef(0);
    var _b = React.useState(function () { return questions.length === 0; }), isCompleted = _b[0], setIsCompleted = _b[1];
    ...
    var handleSaveAnswer = React.useCallback(function (data) {
        var _a, _b, _c, _d;
        ...
        (_d = ref.current) === null || _d === void 0 ? void 0 : _d.updateMessage({
            ...
            type: 'text',
            sender: 'magneto',
            content: tslib_es6.__assign(tslib_es6.__assign({}, questionState), { answer: answer, mode: mode })
        });
    ...
    var handleGetAnswers = React.useCallback(function () {
        var _a;
    ...
    var handleReset = React.useCallback(function (questionnaire) {
        var _a;
...
exports.useChatQuestionnaire = useChatQuestionnaire;
