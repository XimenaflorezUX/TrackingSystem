...
import SimilarJobsCard from './children/SimilarJobsCard/SimilarJobsCard.component.js';
...
var SimilarJobs = function (_a) {
    ...
    if (similarJobsCard.length <= 0)
        return null;
    return (React.createElement("div", { className: "".concat(styles["".concat(classMUI, "-similar-jobs-section")]) }, similarJobsCard.map(function (_a) {
