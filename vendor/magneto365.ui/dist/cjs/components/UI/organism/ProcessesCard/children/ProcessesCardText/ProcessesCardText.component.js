...
var Component = function (_a) {
    ...
    return (React__default["default"].createElement("p", { className: cx('processes-card__text', className, "processes-text-status--".concat(status), {
            'processes-card__text--strong': strong
        }) }, children));
};
var ProcessesCardText = Component;

exports.ProcessesCardText = ProcessesCardText;
