...
var ApplicationSection_component = require('./children/ApplicationSection/ApplicationSection.component.js');
...
var ModalResponsive_component = require('../../molecules/ModalResponsive/ModalResponsive.component.js');
...
var ApplicationTitle_component = require('./children/ApplicationTitle/ApplicationTitle.component.js');
var ApplicationSubTitle_component = require('./children/ApplicationSubTitle/ApplicationSubTitle.component.js');
var ApplicationButton_component = require('./children/ApplicationButton/ApplicationButton.component.js');
var ApplicationText_component = require('./children/ApplicationText/ApplicationText.component.js');
var ApplicationSummary_module = require('./ApplicationSummary.module.scss.js');

function _interopDefaultLegacy (e) { return e && typeof e === 'object' && 'default' in e ? e : { 'default': e }; }

var React__default = /*#__PURE__*/_interopDefaultLegacy(React);

var cx = classNames_util.classNames.bind(ApplicationSummary_module);
var Component = function (_a) {
    var children = _a.children, className = _a.className, props = tslib_es6.__rest(_a, ["children", "className"]);
    return (React__default["default"].createElement(ModalResponsive_component.ModalResponsive, tslib_es6.__assign({ modalClassName: cx('summary-modal', className), mobileDrawerClassName: cx('summary-drawer') }, props), children));
};
var ApplicationSummary = Object.assign(Component, {
    Section: ApplicationSection_component.ApplicationSection,
    Title: ApplicationTitle_component.ApplicationTitle,
    SubTitle: ApplicationSubTitle_component.ApplicationSubtitle,
    Button: ApplicationButton_component.ApplicationButton,
    Text: ApplicationText_component.ApplicationText
});

exports.ApplicationSummary = ApplicationSummary;
//# sourceMappingURL=ApplicationSummary.component.js.map
