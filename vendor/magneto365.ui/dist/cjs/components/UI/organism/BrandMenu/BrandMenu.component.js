...
var BrandsMenuMobile_component = require('../../molecules/BrandsMenuMobile/BrandsMenuMobile.component.js');
var BrandsMenuPopover_component = require('../../molecules/BrandsMenuPopover/BrandsMenuPopover.component.js');
...
var BrandMenu = function (_a) {
    ...
    var brandMenuprops = {
        brandsProps: brandsProps,
        companyLogo: companyLogo,
        companySlug: companySlug
    };
    var menuResponsive = index.useMediaQuery(React__default["default"].createElement(BrandsMenuPopover_component, tslib_es6.__assign({}, brandMenuprops)), {
        md: React__default["default"].createElement(BrandsMenuMobile_component, tslib_es6.__assign({}, brandMenuprops))
    });
    return React__default["default"].createElement(React__default["default"].Fragment, null, menuResponsive);
};

module.exports = BrandMenu;
//# sourceMappingURL=BrandMenu.component.js.map
