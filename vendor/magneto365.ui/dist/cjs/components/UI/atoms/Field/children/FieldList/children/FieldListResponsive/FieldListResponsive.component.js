...
var FieldListResponsive_module = require('./FieldListResponsive.module.scss.js');

function _interopDefaultLegacy (e) { return e && typeof e === 'object' && 'default' in e ? e : { 'default': e }; }

var React__default = /*#__PURE__*/_interopDefaultLegacy(React);

var cx = classNames_util.classNames.bind(FieldListResponsive_module);
var BaseComponent = function (_a) {
    var children = _a.children;
    var _b = Field_context.useFieldContext(), isFocused = _b.isFocused, isMobile = _b.isMobile, setIsFocused = _b.setIsFocused;
    var Container = React.useMemo(function () { return (isMobile ? MobileDrawer_component.MobileDrawer : React__default["default"].Fragment); }, [isMobile]);
    var mobileProps = React.useMemo(function () {
        return isMobile && {
            isOpen: isFocused,
    ...
    return React__default["default"].createElement(Container, tslib_es6.__assign({}, mobileProps), children);
};
var FieldListResponsive = BaseComponent;

exports.FieldListResponsive = FieldListResponsive;
