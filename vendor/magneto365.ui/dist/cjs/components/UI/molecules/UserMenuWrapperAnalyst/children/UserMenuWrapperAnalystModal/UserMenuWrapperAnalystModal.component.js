...
require('../UserMenuWrapperAnalystDropdown/UserMenuWrapperAnalystDropdown.component.js');
var UserMenuWrapperAnalystModal_module = require('./UserMenuWrapperAnalystModal.module.scss.js');
...
var Component = function (_a) {
    ...
    return (React__default["default"].createElement(React__default["default"].Fragment, null,
        React__default["default"].createElement(MobileDrawer_component.MobileDrawer, { isOpen: clickOut, onClose: function () { return setClickOut(!clickOut); }, className: classNameManager_util.get({ styles: UserMenuWrapperAnalystModal_module, cls: ['user-menu-wrapper-analyst-modal'] }) },
            React__default["default"].createElement(UserMenuAnalyst_component.UserMenuAnalyst, { isMenuOpen: clickOut, user: user, action: action, handleModal: handleModal, handleMenuOpen: setClickOut, headerSections: headerSections, footerSections: footerSections })),
        React__default["default"].createElement(UserMenuButtonAnalyst_component.UserMenuButtonAnalyst, { user: user.name, title: user.title, onClick: function () { return setClickOut(true); } })));
};
/**
...
exports.UserMenuWrapperAnalystModal = UserMenuWrapperAnalystModal;
