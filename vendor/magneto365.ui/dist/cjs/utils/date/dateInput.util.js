...
var DateArray = /** @class */ (function () {
    ...
    DateArray.prototype.getArray = function () {
        return tslib_es6.__spreadArray(tslib_es6.__spreadArray(tslib_es6.__spreadArray([], this.raw.day, true), this.getMonth(), true), this.raw.year, true);
    };
...
exports.fixArrayDate = fixArrayDate;
