...
import BrandsMenuMobile from '../../molecules/BrandsMenuMobile/BrandsMenuMobile.component.js';
import BrandsMenuPopover from '../../molecules/BrandsMenuPopover/BrandsMenuPopover.component.js';
...
var BrandMenu = function (_a) {
    ...
    var menuResponsive = useMediaQuery(React.createElement(BrandsMenuPopover, __assign({}, brandMenuprops)), {
        md: React.createElement(BrandsMenuMobile, __assign({}, brandMenuprops))
    });
    return React.createElement(React.Fragment, null, menuResponsive);
};

export { BrandMenu as default };
