...
var MobileSideCards = function (_a) {
    ...
    return (React__default["default"].createElement("div", { className: withSideCards_module['mega-menu-side-container'] }, showContent ? (React__default["default"].createElement("div", { className: withSideCards_module['mega-menu-side-container__main'] },
        React__default["default"].createElement(WrappedComponent, tslib_es6.__assign({}, wrapperProps)))) : (React__default["default"].createElement("div", { className: withSideCards_module['mega-menu-side-container__side'] },
        React__default["default"].createElement(MegaMenuSideCards_component, tslib_es6.__assign({}, sideProps))))));
};

module.exports = MobileSideCards;
//# sourceMappingURL=withSideCardsMobile.js.map
