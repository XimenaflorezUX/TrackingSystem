...
var LoginJobsHeader_component = require('../../organism/LoginJobsHeader/LoginJobsHeader.component.js');
...
var LoginJobsTemplate_module = require('./LoginJobsTemplate.module.scss.js');
...
var LoginJobsTemplate = function (_a) {
    ...
    return (React__default["default"].createElement("div", { className: LoginJobsTemplate_module["".concat(Muiclass, "-logout-jobs-template")] },
        React__default["default"].createElement(LoginJobsHeader_component, tslib_es6.__assign({}, LoginJobsHeaderProps, { onMenuClick: function () { return setToggleDrawer(true); } })),
        React__default["default"].createElement(Drawer_component.Drawer, { isOpen: toggleDrawer, onClose: function () { return setToggleDrawer(false); } },
            React__default["default"].createElement("div", { className: LoginJobsTemplate_module["".concat(Muiclass, "-logout-jobs-template--brands")] },
                ...
                React__default["default"].createElement("a", { href: companyUrl },
                    React__default["default"].createElement("img", { className: LoginJobsTemplate_module["".concat(Muiclass, "-logout-jobs-template--company-logo")], src: companyLogo, alt: companySlug ? companySlug : '' }))),
            React__default["default"].createElement("div", { className: LoginJobsTemplate_module["".concat(Muiclass, "-logout-jobs-template--jobs-menu")] },
                React__default["default"].createElement(ListMenuItems_component.ListMenuItems, tslib_es6.__assign({}, listMenuProps))),
            React__default["default"].createElement("div", { className: LoginJobsTemplate_module["".concat(Muiclass, "-logout-jobs-template--social-media")] }, ListIcon && React__default["default"].createElement(ListIconLink_component.ListIconLink, { size: 34, spacing: 20, listIcon: ListIcon })))));
};

module.exports = LoginJobsTemplate;
