...
var JobDetailsDrawer_module = require('./JobDetailsDrawer.module.scss.js');
var JobDetailsSkeleton_component = require('./children/JobDetailsSkeleton.component.js');
...
var Component = function (_a) {
    ...
    return (React__default["default"].createElement(React.Fragment, null,
        jobDetailAction ? (jobDetailAction) : (React__default["default"].createElement("section", { className: JobDetailsDrawer_module.JobDetailsDrawerComponent },
            alert && (React__default["default"].createElement("div", { className: JobDetailsDrawer_module['CompletionAlertWrapper'] },
                React__default["default"].createElement(Alert_component.Alert, tslib_es6.__assign({}, alert)))),
            React__default["default"].createElement("div", { className: JobDetailsDrawer_module['JobHeaderCardWrapper'] },
                React__default["default"].createElement(JobCompanyHeader_component.JobCompanyHeader, tslib_es6.__assign({}, jobCompanyLogoProps, { isApplied: isApplied, jobActionsProps: jobActionsProps })),
                (canApply === null || canApply === void 0 ? void 0 : canApply.isApplicable) === false && (React__default["default"].createElement(Alert_component.Alert, { type: "info", text: canApply === null || canApply === void 0 ? void 0 : canApply.message, className: JobDetailsDrawer_module.JobLockedAlert })),
                isApplied ? (React__default["default"].createElement(AlertJobStatus_component.AlertJobStatus, tslib_es6.__assign({}, alertJobStatusProps))) : (React__default["default"].createElement(JobActions_component.JobActions, tslib_es6.__assign({ actionsAnchorIcons: isDetailVariant ? vacancies_constants.anchorIconListJobsActions2 : vacancies_constants.anchorIconList }, jobActionsProps, { isApplied: isApplied, isJobDetailPage: isJobDetailPage, variant: variant })))),
            React__default["default"].createElement("div", { className: JobDetailsDrawer_module['JobBodyCardWrapper'], ref: jobDetailsRef },
                jobDetailsProps && (React__default["default"].createElement(JobDetails_component.JobDetails, { altList: vacancies_constants.altList, iconList: vacancies_constants.iconDetailList, offerDetailsList: jobDetailsProps, cities: cities, isRemote: isRemote, textRemote: textRemote })),
                ...
                React__default["default"].createElement(JobSkillsCard_component.JobSkillsCard, tslib_es6.__assign({}, jobSkillsCardProps)),
                ...
                React__default["default"].createElement(JobApplyCard_component.JobApplyCard, tslib_es6.__assign({}, jobApplyCardProps)),
                React__default["default"].createElement(JobFooterCard_component.JobFooterCard, tslib_es6.__assign({ iconList: vacancies_constants.iconFooterList }, jobFooterCardProps, { variant: variant })),
