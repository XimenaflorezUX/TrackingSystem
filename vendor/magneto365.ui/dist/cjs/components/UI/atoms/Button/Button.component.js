...
var cx = classNames_util.classNames.bind(Button_module);
/**
...
var BaseComponent = function (_a, ref) {
    ...
    return (React__default["default"].createElement("button", tslib_es6.__assign({}, props, { ref: ref, type: type, disabled: disabled, "data-lib": "magneto-ui", "data-slot": "button", "data-variant": variant, "data-size": size, "aria-disabled": disabled, className: cx('magneto-ui-button', "magneto-ui-button--".concat(variant), "magneto-ui-button--".concat(size), fullWidth ? 'magneto-ui-button--full-width' : undefined, disabled ? 'magneto-ui-button--disabled' : undefined, className) }),
        startIcon && (React__default["default"].createElement("span", { className: cx('magneto-ui-button__icon'), "aria-hidden": "true" }, startIcon)),
        label && (React__default["default"].createElement("span", { className: cx('magneto-ui-button__label') }, label)),
        endIcon && (React__default["default"].createElement("span", { className: cx('magneto-ui-button__icon'), "aria-hidden": "true" }, endIcon))));
};
