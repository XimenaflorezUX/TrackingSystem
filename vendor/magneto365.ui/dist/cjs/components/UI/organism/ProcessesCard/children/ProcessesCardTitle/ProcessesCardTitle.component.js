...
var Component = function (_a) {
    ...
    return React__default["default"].createElement("h3", { className: cx('processes-card__title', className, "processes-text-status--".concat(status)) }, children);
};
var ProcessesCardTitle = Component;

exports.ProcessesCardTitle = ProcessesCardTitle;
