...
import ListMenuText from '../../molecules/ListMenuText/ListMenuText.component.js';
...
import MenuCollapse from '../../molecules/MenuCollapse/MenuCollapse.component.js';
import style from './FooterMenuLinks.module.scss.js';
...
var FooterMenuLinks = function (_a) {
    ...
    var footerMenuResponsive = useMediaQuery(React.createElement("div", { className: "".concat(style["".concat(classMUI, "-menu-list")]) },
        React.createElement("div", { className: "".concat(style["".concat(classMUI, "-menu-list__columns")]) },
...
export { FooterMenuLinks as default };
