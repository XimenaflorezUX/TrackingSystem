...
var BaseComponent = function (_a, ref) {
    ...
    return (React__default["default"].createElement("p", tslib_es6.__assign({}, Typography_constant.omitTypographyProps(props), { className: className, style: style, ref: ref }), Typography_constant.applyWrappers(children, props)));
};
