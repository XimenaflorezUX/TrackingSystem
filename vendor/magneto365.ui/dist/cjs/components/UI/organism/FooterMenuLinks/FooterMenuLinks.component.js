...
var ListMenuText_component = require('../../molecules/ListMenuText/ListMenuText.component.js');
...
var MenuCollapse_component = require('../../molecules/MenuCollapse/MenuCollapse.component.js');
var FooterMenuLinks_module = require('./FooterMenuLinks.module.scss.js');
...
var FooterMenuLinks = function (_a) {
    var menuList = tslib_es6.__rest(_a, []);
    ...
    var footerMenuResponsive = index.useMediaQuery(React__default["default"].createElement("div", { className: "".concat(FooterMenuLinks_module["".concat(common_constants.classMUI, "-menu-list")]) },
        React__default["default"].createElement("div", { className: "".concat(FooterMenuLinks_module["".concat(common_constants.classMUI, "-menu-list__columns")]) },
            React__default["default"].createElement(ListMenuText_component, tslib_es6.__assign({}, personsMenu))),
        React__default["default"].createElement("div", { className: "".concat(FooterMenuLinks_module["".concat(common_constants.classMUI, "-menu-list__columns")]) },
            React__default["default"].createElement(ListMenuText_component, tslib_es6.__assign({}, magnetoMenu)),
            React__default["default"].createElement(ListMenuText_component, tslib_es6.__assign({}, magnetoLiteMenu)),
            React__default["default"].createElement(ListMenuText_component, tslib_es6.__assign({}, otherSolutionsMenu))),
        React__default["default"].createElement("div", { className: "".concat(FooterMenuLinks_module["".concat(common_constants.classMUI, "-menu-list__columns")]) },
            React__default["default"].createElement(ListMenuText_component, tslib_es6.__assign({}, legalMenu)))), {
        sm: React__default["default"].createElement(MenuCollapse_component, { listMenu: menuList })
    });
    return React__default["default"].createElement(React__default["default"].Fragment, null, footerMenuResponsive);
};

module.exports = FooterMenuLinks;
//# sourceMappingURL=FooterMenuLinks.component.js.map
