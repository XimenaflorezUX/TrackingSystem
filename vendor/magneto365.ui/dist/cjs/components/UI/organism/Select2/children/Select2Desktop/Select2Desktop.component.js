...
var Select2Desktop_module = require('./Select2Desktop.module.scss.js');
...
var Component = function (_a) {
    ...
    return (React__default["default"].createElement("div", { className: classNameManager_util.get({ styles: Select2Desktop_module, cls: ['select2-desktop', className] }) },
        React__default["default"].createElement(Select2Input_component.Select2Input, { searchValue: searchValue, placeholder: placeholder, clickOut: clickOut, disabled: disabled, handleSearch: handleSearch, setClickOut: setClickOut, disableList: disableList, icon: icon, valueSelected: valueSelected, isMultiple: isMultiple, setTerm: setTerm }),
        ...
        React__default["default"].createElement(Select2List_component.Select2List, { disabledList: disableList, list: list, onSelected: handleChange, selected: valueSelected, visible: clickOut, render: render })));
};
/**
...
exports.Select2Desktop = Select2Desktop;
