...
var SimilarJobsCard_component = require('../../molecules/SimilarJobsCard/SimilarJobsCard.component.js');
...
var SimilarJobs = function (_a) {
    ...
    if (similarJobsCard.length <= 0)
        return null;
    return (React__default["default"].createElement("div", { className: "".concat(SimilarJobs_module["".concat(common_constants.classMUI, "-similar-jobs-section")]) },
        React__default["default"].createElement("p", { className: "".concat(SimilarJobs_module["".concat(common_constants.classMUI, "-similar-jobs-section__title")]) }, "".concat(sectionTitle, ":")),
