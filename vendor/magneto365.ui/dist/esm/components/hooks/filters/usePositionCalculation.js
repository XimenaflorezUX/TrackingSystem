...
var usePositionCalculation = function (_a) {
    ...
    var _d = useState({ top: 0, left: 0 }), popoverPosition = _d[0], setPopoverPosition = _d[1];
    var _e = useState({ top: 0, left: 0 }), tooltipPosition = _e[0], setTooltipPosition = _e[1];
    var calculatePositions = useCallback(function (buttonElement) {
