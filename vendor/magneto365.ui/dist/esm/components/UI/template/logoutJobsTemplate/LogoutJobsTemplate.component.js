...
import { logoProps, SignUpButtonStyle, SignInIcon } from '../../../../constants/stories/common.constants.js';
...
import LogoutJobsHeader from '../../organism/LogoutJobsHeader/LogoutJobsHeader.component.js';
...
import style from './LogoutJobsTemplate.module.scss.js';
...
var LogoutJobsTemplate = function (_a) {
    ...
    return (React.createElement("div", { className: style["".concat(Muiclass, "-logout-jobs-template")] },
        React.createElement(LogoutJobsHeader, __assign({}, logoutJobsHeaderProps, { onMenuClick: function () { return setToggleDrawer(true); } })),
        React.createElement(Drawer, { isOpen: toggleDrawer, onClose: function () { return setToggleDrawer(false); } },
            ...
            React.createElement("div", { className: style["".concat(Muiclass, "-logout-jobs-template--btn-actions")] },
                React.createElement(MainButton, __assign({ buttonSize: "full" }, SignUpButtonStyle, { buttonText: buttonText, onClick: onClick, loadingState: loadingState })),
                React.createElement(Link, { type: type, href: href, text: text, iconProps: SignInIcon })),
...
export { LogoutJobsTemplate as default };
