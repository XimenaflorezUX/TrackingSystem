...
var SelectDrawer_module = require('./SelectDrawer.module.scss.js');

function _interopDefaultLegacy (e) { return e && typeof e === 'object' && 'default' in e ? e : { 'default': e }; }

var React__default = /*#__PURE__*/_interopDefaultLegacy(React);

var cx = classNames_util.classNames.bind(SelectDrawer_module);
var SelectDrawer = function (_a) {
    var className = _a.className, children = _a.children;
    var _b = Select_component.Select.useContext(), open = _b.open, onSwitch = _b.onSwitch;
    return (React__default["default"].createElement(MobileDrawer_component.MobileDrawer, { className: cx('select-drawer', className), isOpen: open, onClose: function () { return onSwitch(false); }, blockBackgroundClose: true }, children));
};
