...
var SelectItem = function (_a) {
    ...
    var selectedSelection = React.useMemo(function () {
        return selected ? SelectItem_module['selected'] : '';
    }, [selected]);
    return (React__default["default"].createElement("button", { className: "".concat(SelectItem_module["".concat(common_constants.classMUI, "-select-item")], " ").concat(disableSelection, " ").concat(selectedSelection), title: text, onClick: onClick }, text));
};
