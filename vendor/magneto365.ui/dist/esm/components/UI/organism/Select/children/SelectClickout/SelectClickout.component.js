...
import styles from './SelectClickout.module.scss.js';
...
var SelectClickout = function (_a) {
    ...
    if (open)
        return React.createElement("div", { className: cx('select-click-out') }, children);
    return null;
};
var SelectClickout$1 = withClickOut(SelectClickout);

export { SelectClickout$1 as default };
