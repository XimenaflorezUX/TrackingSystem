...
var MobileSideCards = function (_a) {
    ...
    return (React.createElement("div", { className: styles['mega-menu-side-container'] }, showContent ? (React.createElement("div", { className: styles['mega-menu-side-container__main'] },
        React.createElement(WrappedComponent, __assign({}, wrapperProps)))) : (React.createElement("div", { className: styles['mega-menu-side-container__side'] },
        React.createElement(MegaMenuSideCards, __assign({}, sideProps))))));
};

export { MobileSideCards as default };
